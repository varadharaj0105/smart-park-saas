...
SELECT 'Alice Admin', 'alice@uptown.com', '$2b$10$QnYtoVCPoZ672BJi6COPxH9ae61gZuVMo0njbHh3XladtZ9Vx', 'company_admin', id, 'Uptown Parking Solutions'
FROM companies WHERE name = 'Uptown Parking Solutions' LIMIT 1
ON CONFLICT (email) DO NOTHING;

INSERT INTO users (name, email, password, role, tenant_id, company_name)
SELECT 'Bob User', 'bob@m.com', '$2b$10$QnYtoVCPoZ672BJi6COPxH9ae61gZuVMo0njbHh3XladtZ9Vx', 'customer', id, 'Uptown Parking Solutions'
FROM companies WHERE name = 'Uptown Parking Solutions' LIMIT 1
ON CONFLICT (email) DO NOTHING;

INSERT INTO users (name, email, password, role, tenant_id, company_name)
SELECT 'Charlie Admin', 'charlie@metro.com', '$2b$10$QnYtoVCPoZ672BJi6COPxH9ae61gZuVMo0njbHh3XladtZ9Vx', 'company_admin', id, 'Metro Park Inc.'
FROM companies WHERE name = 'Metro Park Inc.' LIMIT 1
ON CONFLICT (email) DO NOTHING;

INSERT INTO users (name, email, password, role, tenant_id, company_name)
SELECT 'Dave User', 'dave@m.com', '$2b$10$QnYtoVCPoZ672BJi6COPxH9ae61gZuVMo0njbHh3XladtZ9Vx', 'customer', id, 'Metro Park Inc.'
FROM companies WHERE name = 'Metro Park Inc.' LIMIT 1
ON CONFLICT (email) DO NOTHING;
